...
<div class="Massive-portfolio portfolio <?php echo esc_attr( $masonry_class ); ?> <?php echo esc_attr( $grid_class ); ?> <?php echo esc_attr( $gutter_class ); ?>">
            ...
            <div class="thumb">
                ...
                <?php if ( 'lightbox' == $hover_view ) { ?>
                    <div class="portfolio-hover">
                        ...
                        <?php } else { ?>
                            <div class="action-btn">
                                <a href="<?php echo esc_url( $thumbnail_url[0] ); ?>" class="popup-link" title="<?php echo sprintf( "%s%s", esc_attr_e( 'lightbox view: ', 'massive-engine' ), the_title() ); ?>"> <i class="icon-basic_magnifier"></i>
                                </a>
                            </div>
                        <?php } ?>
                        <div class="portfolio-description">
                            <h4>
                                <a href="<?php echo esc_url( $thumbnail_url[0] ); ?>" class="popup-link" title="<?php echo sprintf( "%s%s", esc_attr_e( 'lightbox view: ', 'massive-engine' ), the_title() ) ; ?>"> <?php the_title(); ?></a>
                            </h4>
                            <p>
                ...
                <?php } elseif ( 'single' == $hover_view ) { ?>
                    <div class="portfolio-hover">
                        <div class="action-btn">
                            <a href="<?php esc_url( the_permalink() ); ?>" title="<?php the_title(); ?>"><i class="icon-basic_link"></i></a>
                        </div>
                        <div class="portfolio-description">
                            <h4>
                ...
                <?php } elseif ( 'video' == $hover_view ) { ?>
                    <div class="portfolio-hover">
                        ...
                        <div class="portfolio-description">
                            <h4>
                                <a href="<?php echo esc_url( $lightbox_video ); ?>" class="popup-vimeo" title="<?php printf( esc_attr__( 'Video Lightbox: %1$s', 'massive-engine' ), get_the_title() ) ; ?>"><?php the_title(); ?></a>
                            </h4>
                            <p>
                                <?php
                                if ( $custom_subtitle !== '' ) {
