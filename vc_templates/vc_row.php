...
if ( ! empty( $full_width ) ) {
    ...
    if ( 'fixed' === $full_width || 'boxed' === $full_width ) {
        $massive_container = 'container';
    }
...
$output .= ( $massive_container ) ? sprintf( '<div class="%s"><div class="row">', esc_attr( $massive_container ) ) : '';
$output .= wpb_js_remove_wpautop( $content );
$output .= ( $massive_container ) ? '</div></div>' : '';
$output .= '</div>';
$output .= $after_output;
