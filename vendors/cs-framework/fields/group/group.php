...
class CSFramework_Option_group extends CSFramework_Options {
  ...
  public function output() {
    ...
    $acc_title   = ( isset( $this->field['accordion_title'] ) ) ? $this->field['accordion_title'] : esc_html__( 'Adding', 'massive' );
    ...
    echo '<div class="cs-group hidden">';
      ...
      echo '<div class="cs-element cs-text-right"><a href="#" class="button cs-warning-primary cs-remove-group">'. esc_html__( 'Remove', 'massive' ) .'</a></div>';
      echo '</div>';
